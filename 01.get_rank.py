...
def get_rank(args):
    ...
    db_path = '/home/image-retrieval/ndir_simulated/features_1121/beitv2_large_patch16_224_in22k_224_01.db_new.pth'
    db_feat = torch.load(db_path).numpy()
    #print(query_feat.shape) #q.shape (100, 768) // db.shape (3377, 768)
    ...
    index.add(db_feat)
    D, I = index.search(query_feat, db_feat.shape[0])
    #D, I = index.search(query_feat, 3000)
    #print(I.shape) #(100, 100)
    ...
    print(f'beitv2_large_patch16_224_in22k: {rank_sum / I.shape[0]: .6f}', file=f)
    print(f'[beitv2_large_patch16_224_in22k] finish')
    f.close() 

    print(f'beitv2_large_patch16_224_in22k: {rank_sum / I.shape[0]: .6f}')
    ############### quality analysis #####################
...
if __name__ == '__main__':
    ...
    query_path = '/home/image-retrieval/ndir_simulated/features_1121/beitv2_large_patch16_224_in22k_224_01.q_origin.pth'
