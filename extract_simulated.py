...
if __name__ == '__main__':
    ...
    transforms = ['01.db_new']
    activations = dict() 

    for transform in transforms:
        extract_frame_features(model, transform, args, activations)
